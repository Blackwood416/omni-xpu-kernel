// Standalone A770 driver for VTune profiling of the DG2 v3 SDP sidecar.
//
// Loads the installed lgrf_sdp sidecar and calls sdp_fp16 repeatedly on a
// fixed L=8192/H=32/D=128 fp16 input, so VTune sees only the two kernels
// (pack + attn) without python/torch host noise.
//
